...
// };
  ...
  const deleteTodo = async (id) => {
    ...
    try {
      ...
      setTodos(prev => [deletedTodo, ...prev]); // Rollback
    }
  };
...
const clearCompleted = async () => {
  ...
  setTodos(prev => prev.filter(todo => !todo.completed)); // Optimistic UI
  ...
  try {
    ...
    // Re-add them in case of failure
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {/* Filter Buttons with Progress Card */}
        <div className="flex flex-wrap gap-4 mb-8 justify-center items-center">
          ...
          <button
            ...
            className={`${filter === 'overdue' ? 'btn-danger' : 'btn-secondary'} ${overdueTodos.length > 0 ? 'animate-pulse' : ''}`}
          >
